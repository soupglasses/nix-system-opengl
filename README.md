...
3. <a name="ref-4"></a> While Nvidia is functional in nix-system-graphics, it requires manual effort to be kept in sync with the __exact__ version of the host. See [this Github comment](https://github.com/soupglasses/nix-system-graphics/issues/5#issuecomment-2443771338) for how this is done. [nix-gl-host](https://github.com/numtide/nix-gl-host/) may be a better alternative if the other above features of nix-system-graphics is not required, and a set-and-forget approach is desired.
